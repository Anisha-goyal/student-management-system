...
<h1 align="center" style="margin-top:100px;font-size:50px">Student Login</h1>
<form action="studentlogin.php" method="post">
	<table align="center">
	<tr>
		<td style="font-size:25px">ID</td>
		<td><input type="text" name="uname" required  pattern="^[0-9]{3}$" title="Enter 3 digit Unique ID" > </td>
	</tr>
	<tr>
...
if(isset($_POST["submit"]))
{
	...
	$qry="SELECT * FROM stulogin where id='$username' and  BINARY password='$password'";
