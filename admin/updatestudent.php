...
<form action="updatestudent.php" method="post" enctype="multipart/form-data">
	<h3 align="center" style="color:#000066; font-size:35px;margin-top:35px;">Update Student Details</h3>
	...
	else
	{
		...
		while($data=mysqli_fetch_assoc($run))
		{
            ...
            <tr align="center" >
				...
				<td><a href="updateform.php?sid=<?php echo $data['id'];?>">Edit</a></td>  <!-- '?'' left side is url and ryt side is the variable created(sid) to send the data to updateform.php throught get method-->
